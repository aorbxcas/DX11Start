...
{
public:
	static IndexedTriangleList MakeTesselated(myVertex::VertexLayout layout, int latDiv,int longDiv )
	{
		...
		myVertex::VertexBuffer vb{ std::move( layout ) };
	...
	static IndexedTriangleList Make(std::optional<myVertex::VertexLayout> layout = std::nullopt)
	{
		//return MakeTesselated<V>( 12,24 );
		using Element = myVertex::VertexLayout::ElementType;
		if( !layout )
		{
			layout = myVertex::VertexLayout{}.Append( Element::Position3D );
		}

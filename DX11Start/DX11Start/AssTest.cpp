	...
	TestObject( gfx,rng,adist,ddist,odist,rdist )
{
	...
	if( !IsStaticInitialized() )
	{
		...
		{
			vbuf.EmplaceBack(dx::XMFLOAT3{pMesh->mVertices[i].x * scale,pMesh->mVertices[i].y * scale,pMesh->mVertices[i].z * scale},*reinterpret_cast<dx::XMFLOAT3*>(&pMesh->mNormals[i]));
		}
